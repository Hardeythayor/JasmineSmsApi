...
class ListenLGPushbulletStream extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'lgpushbullet:listen';
     ...
     * @var string
     */
    protected $description = 'Connects to LG Pushbullet WebSocket stream and listens for messages.';
    ...
    {
        $apiKey = config("pushbullet.keys.lg");//$this->argument('apiKey');
